...
import irs.fdxtax640.jsonserializers.Tax1099MiscSerializer;
import irs.fdxtax640.jsonserializers.TaxStatementListSerializer;
import irs.fdxtax640.map2objects.Map2Tax1099Misc;
import irs.fdxtax640.obj2mappers.TaxStatementList2Map;

import org.apache.commons.lang3.time.StopWatch;
import org.taxdataexchange.core.pdfbuilders.Tax1099MiscPdfBuilder;
...
public class Tax1099MiscDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099Misc obj = Map2Tax1099Misc.generate( row );
        {
            String asJson = Tax1099MiscSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099Misc.csv";
        ...
        String outputFileName = "Tax1099Misc.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099MiscDocumentGenerator generator = new Tax1099MiscDocumentGenerator( );
