# tax-doc-sdk-tax1099misc

Software development kit to generate IRS Form 1099-MISC as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099Misc.sample.png" width="850"/>
